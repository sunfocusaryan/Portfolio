        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Hello! I'm Aryan Chouhan, a passionate React Developer based in
              Chandigarh. I enjoy creating things that live on the internet,
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              I graduated from SRM Institute of Science and Technology with a
              Bachelor’s degree in Computer Science and also completed my
              Master’s degree from the same university. I have 2 years of
              professional experience in the web development industry, with a
              strong foundation in JavaScript, React.js, and modern CSS
              frameworks. I focus on building responsive, user-friendly, and
